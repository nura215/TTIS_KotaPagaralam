    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/properties/{{ $property->slug }}" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <select class="form-select @error('property') is-invalid @enderror" id="property" name="property" required>
                <option value="Logo" {{ old('property', $property->property) == 'Logo' ? 'selected' : '' }}>Logo</option>
                <option value="Banner" {{ old('property', $property->property) == 'Banner' ? 'selected' : '' }}>Banner</option>
                <option value="Icon Dasbor" {{ old('property', $property->property) == 'Icon Dasbor' ? 'selected' : '' }}>Icon Dasbor</option>
                <option value="Icon Profile" {{ old('property', $property->property) == 'Icon Profile' ? 'selected' : '' }}>Icon Profile</option>
              </select>
              @error('property')
